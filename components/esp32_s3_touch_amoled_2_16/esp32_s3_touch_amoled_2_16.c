...
static lv_display_t *bsp_display_lcd_init(const bsp_display_cfg_t *cfg)
{
    ...
    const bsp_display_config_t disp_config = {
        /* DMA buffer must be in internal RAM; keep single transfer small to fit in
         * fragmented DMA heap. 16 rows * 480 * 2 = 15360 bytes is safe even with
         * esp_new_jpeg library occupying some internal RAM. */
